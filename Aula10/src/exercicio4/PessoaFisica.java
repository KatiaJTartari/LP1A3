 ...
 *             de texto dentro da janela Clientes - Pessoa Física se retirar os
...
public class PessoaFisica extends JDialog {
	...
	public PessoaFisica() {
		//lbTitulo = new JLabel("Clientes - Pessoa Física");

		setTitle("Clientes - Pessoa Física"); // Título da janela.
