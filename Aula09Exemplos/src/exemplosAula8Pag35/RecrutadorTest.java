...
import exemplosAula8Pag31a33.CriadorDeVaga;
...
public class RecrutadorTest {
	...
	// Este parametro da linha abaixo tem que comentar conforme o exemplo da página 35,
	// por causa do RuntimeException da classe Recrutador exemplo da página 35, mas não sei se está certo.
	@Test(expected=RuntimeException.class)
